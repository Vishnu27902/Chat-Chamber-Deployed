...
async function getUsers() {
  let res = await axios.get(`https://chat-chamber-app.onrender.com/home/getusers?roomID=${roomID}`)
  res = res.data
  if (res.success) {
...
async function getRoomName() {
  ...
  await getUsers(room)
  let res = await axios.get(`https://chat-chamber-app.onrender.com/home/getroomname?roomID=${room}`)
  res = res.data
  if (res.success) {
...
socket.on("dbUserData", async (userData) => {
  ...
  let res = await axios.post("https://chat-chamber-app.onrender.com/home/adduser", userData)
  res = res.data
  if (res.success) {
